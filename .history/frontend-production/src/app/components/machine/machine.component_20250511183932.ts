...
TS2305: Module '"ng2-charts"' has no exported member 'SingleDataSet'.
src/app/components/machine/machine.component.ts:17:9
...
export class MachineComponent implements OnInit {
  machines: any[] = [];
chartLabels: Label[] = ['Actives', 'En Panne'];
  chartData: SingleDataSet = [0, 0];
  constructor(
 ...
 updateChart() {
    this.chartData = [this.machinesActives, this.machinesEnPanne];
  }
