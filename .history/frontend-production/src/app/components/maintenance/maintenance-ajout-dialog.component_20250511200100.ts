...
<mat-form-field appearance="outline" class="full-width">
  ...
  <mat-select [(ngModel)]="data.maintenance.type" name="type" required>
    <mat-option value="Préventive">🛠️ Préventive</mat-option>
    <mat-option value="Curative">⚠️ Curative</mat-option>
  </mat-select>
</mat-form-field>
