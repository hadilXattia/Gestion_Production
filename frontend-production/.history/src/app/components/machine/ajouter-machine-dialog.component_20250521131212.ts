...
@Component({
  ...
  imports: [
    ...
    MatInputModule,
    MatButtonModule,
    MatCardModule,MatNativeDateModule,    MatSelectModule
  ],
  template: `
    <mat-card>
      ...
      <form #machineForm="ngForm" (ngSubmit)="submit(machineForm)" class="form-container">
        ...
        <!-- État -->
    <!-- Dans AjouterMachineDialogComponent template -->
<mat-form-field appearance="outline" style="display: block;">
  <mat-label>État</mat-label>
  <mat-select [(ngModel)]="machine.etat" name="etat" #etat="ngModel" required>
  ...
  <div class="error" *ngIf="etat.invalid && etat.touched">L'état est requis.</div>
        ...
        <mat-form-field appearance="outline" style="display: block;">
          ...
          <input matInput type="date" [(ngModel)]="machine.maintenanceProchaine" name="maintenanceProchaine" #maintenanceProchaine="ngModel">
        </mat-form-field>
