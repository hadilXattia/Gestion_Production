    ...
    <mat-card>
      ...
      <form #produitForm="ngForm" (ngSubmit)="submit(produitForm)" class="form-container">
        ...
        <mat-form-field appearance="outline" style="display:block">
          ...
          <mat-select [(ngModel)]="produit.type" name="type" #type="ngModel" required>
            <mat-option value="Electronique">Electronique</mat-option>
            <mat-option value="Mécanique">Mécanique</mat-option>
            <mat-option value="Chimique">Chimique</mat-option>
        ...
        <button mat-button type="button" (click)="onCancel()" style="margin-left: 8px;">
          Annuler
        </button>
      </form>
    </mat-card>
...
export class ProduitUpdateDialogComponent {
  ...
  constructor(
    ...
    if (this.produit.image) {
      this.imagePreview = this.produit.image;
    }
  }
